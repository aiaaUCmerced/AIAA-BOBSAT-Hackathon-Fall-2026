# Event Schedule
This is the schedule for the whole event! Note that we may deviate slightly from this depending on how things go. 

## Friday - 9/11 | Hackathon Release
At end of BOBSAT Meeting
* Release the hackathon repository
* Release prompts and challenge information
* Announce official team formation rules

## Monday — 9/14 | Hackathon Kickoff
5:00–6:00 PM - Setup & Team Formation
* Go over exact prompts and challenge requirements in detail
...
* Check that every team has access to its Box folder and required software

## Wednesday — 9/16 | Work Session
...
* Leads and judges begin reviewing submissions where possible

## Friday — 9/18 | Final Work & Submission
...
## Saturday — 9/19 | Final Event
10:00 AM — Final Work Begins
