...
These are the minimum requirements to be qualified for the cash prize:
1. Your submission must contain each of the elements from the general specification. Each of these involve something that goes into your final presentation.
2  Teams must choose a single detailed specificaton. These detailed specs have a 5 analyses/simulations to choose from, and a team must complete at least one
3. Each deliverable in the general *and* detailed specification requires an explanation of your what you implemented and why that deliverable is useful or necessary. These explanations and justifications should be in the Contributions document.
4. Each member of your team must have contributed to at least 1 deliverable that they were solely responsible for. This should be documented in the Contributions document. Beyond that, you are encouraged to work together on everything. Don't leave the presentation to only 1 person!
5. Each member must speak during the final presentation. The presentation must be uploaded to the box titled "Presentation.pptx". 
6. Teams must upload their completed analyses from the detailed spec into the Analyses folder. The title should look like "SPEC NAME (COMPLETE)". For instance, the assembly file for the first Space Vehicle Engineering deliverable should be "1. CAD Model in Solidworks (COMPLETE).sldasm". 

Beyond the minimum, there are opportunities to earn extra points. The first and most simple route is to perform more than one of the analyses in the detailed spec. Each section also has some examples of extra stuff that you can do, denoted with "For further consideration...". Often, these involve making the analysis more complex or extensive. The items laid out in these sections are just some examples; teams are encouraged to expand beyond those that are mentioned. Extra points will be awarded for implementations that are particularly efficient, clear, large-scope, and technically advanced.
...
1. General Spec Deliverables (12 total)
   * 2 Points each for the Block Diagram, Day in the Life Chart, Mission Overview, and Physical Architecture
   * 2 Points for the Visual component of the presentation, and 2 Points for the Verbal component
2. Detailed Spec Deliverables (36 total)
   * 3 Points if the team completed the minimum deliverables for 1 analysis
   * 9 points for 2 analyses
   * 18 points for 3 analyses
   * 27 points for 4 analyses
   * 36 points for 5 analyses
3. General Spec Further Consideration (22 total)
   * 2 points each for extra work for each General Spec deliverable
   * 5 points for clarity during the presentation
   * 5 points for efficiency during the presentation
4. Detailed Spec Further Consideration (30 total)
   * 3 points each for analyses that extend something from the minimum deliverables
   * 3 points each for analyses that implement something beyond the minimum deliverables
...
**Minimum Requirement**: The physical architecture is a description of what components make up the satellite and how they're composed together. For this event, you will need to interpret the customer documentation (Guidance on Physical Architecture) to get this info. Then, you'll need to concisely present the physical architecture on a dedicated slide in your presentation. Note that the documentation will have only preliminary information on each of these components. The analyses you conduct during the detailed specification may give you more information that you should put in the physical architecture. This could be a trade-off between different components or a more advanced component. A piece of advice for this section: a picture is worth a thousand words!

**For your Consideration**: Going above-and-beyond in this section is pretty easy! One example would be to attach your conceptual physical architecture to a 3D CAD model. Another example would be to show the physical interfaces (fasteners, electrical connectors) between each of the components in an interface matrix. Finally, you could make a logical (alternatively called a functional) architecture and show its correspondence with the physical architecture.  
